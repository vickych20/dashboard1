...
const Sidebar=()=>{
    ...
    return (
      ...
      //         </div>
      <div className="flex gap-6 " data-aos="fade-down-right">
        <div className="bg-[#222222] w-72 text-gray-100 px-4 py-8">
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>
                  {React.createElement(MdOutlineDashboardCustomize, {
                    size: "20",
                  })}
                </div>
                <div>
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>{React.createElement(RiMessage2Line, { size: "20" })}</div>
                <div>
                  <h2>message</h2>
                </div>
              </div>
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>
                  {React.createElement(DiGoogleAnalytics, { size: "20" })}
                </div>
                <div>
                  <h2>analytics</h2>
                </div>
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>
                  {React.createElement(BsFillFileEarmarkPdfFill, {
                    size: "20",
                  })}
                </div>
                <div>
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>
                  {React.createElement(AiOutlineShoppingCart, { size: "20" })}
                </div>
                <div>
                  <h2>Cart</h2>
                </div>
          ...
          <div className="relative flex flex-col gap-6 mt-4">
            <Link to={"/"}>
              <div className="flex gap-6">
                <div>{React.createElement(CiSaveUp1, { size: "20" })}</div>
                <div>
                  <h2>saved</h2>
                </div>
              </div>
        ...
        <div className="m-3 text-xl font-semibold text-gray-700">Sidebar</div>
      </div>
    );
}
