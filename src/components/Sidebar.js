...
'>
<div className='bg-[#222222] min-h-screen w-72 text-gray-100 px-4'>
...
<div className='flex gap-6'>
<div>
    {React.createElement(MdOutlineDashboardCustomize,{size:"20"})}
</div>
<div>
 <h2>Dashboard</h2> 
...
<div className='flex gap-6'>
<div>
    {React.createElement(BiUser,{size:"20"})}
</div>
<div>
 <h2>User</h2> 
...
<div className='flex gap-6'>
<div>
    {React.createElement(RiMessage2Line,{size:"20"})}
</div>
<div>
 <h2>message</h2> 
...
<div className='flex gap-6'>
<div>
    {React.createElement(BsFillFileEarmarkPdfFill,{size:"20"})}
</div>
<div>
 <h2>file Manager</h2> 
...
<div className='flex gap-6'>
<div>
    {React.createElement(CiSaveUp1,{size:"20"})}
</div>
<div>
 <h2>saved</h2> 
...
<div className='m-3 text-xl text-gray-700 font-semibold'>
   Sidebar
</div>
